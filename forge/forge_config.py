...
DISCORD_REPORTS_CHANNEL_ID   = os.environ.get("FORGE_DISCORD_REPORTS_CHANNEL_ID", "1509917708093886475")
DISCORD_APPROVALS_CHANNEL_ID = os.environ.get("FORGE_DISCORD_APPROVALS_CHANNEL_ID", "1509917666889044068")
FORGE_OWNER_ID               = os.environ.get("FORGE_DISCORD_OWNER_ID", "334811986019745792")
